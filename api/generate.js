...
export default async function handler(req, res) {
  ...
  try {
    ...
    const finalPrompt =
      prompt ||
      'На референсе изображена новогодняя открытка с человеком. Сделай мне такую же новогоднюю открытку только с моей фотографией. Используй это фото как базовое. Не менять черты лица вообще. Не менять форму глаз, губ, носа. Сделай из этой фотографии, старую Открытку в стиле Новый год. Добавь ёлочку, зверек елочные игрушки. Стиль советские сказки, формат 9:16. Одежду измени на зимнюю старинную одежду, добавь советскую меховую коричневую шапку из норки и коричневую шубку. Лица остаются максимально похожими как исходном фото, добавь надпись в стиле открытки: «С Новым годом!» (шрифт СССР). Как у Зарубина добавить рамку с орнаментом СССР.';
