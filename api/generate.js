...
export default async function handler(req, res) {
  ...
  try {
    ...
    const finalPrompt =
      prompt ||
      'На референсе изображена новогодняя открытка с человеком. Сделай мне такую же новогоднюю открытку только с моей фотографией. Сохрани стиль который используется в референсе, сохрани цветокоррекцию и детализацию. По максимуму сохрани лицо загруженного пользователем изображения.';
