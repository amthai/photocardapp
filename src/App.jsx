...
const CARD_STYLES = [
  {
    ...
    name: 'Новогодняя',
    emoji: '🎄',
    prompt: 'На первой картинке новогодняя открытка с фотографией девушки. А на второй картинке моя фотография. \n\nЯ хочу такую же новогоднюю открытку со своей фотографией. Изучи референс, я хочу открытку точно в таком же стиле, с такой же детализацеий, с такой же цвето коррекцией.\n\nВажно! Сохрани максимально узнаваемость моего лица.',
